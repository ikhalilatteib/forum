    ...
    <div class="mb-0 " >
        ...
        <div class="d-flex align-items-center mb-4">
            ...
            <a href="../../demo5/dist/apps/devs/question.html"
                class="fs-2 fw-bolder text-gray-900 text-hover-primary me-1">{{ question.title }}</a>
            <!--end::Title-->
            <!--begin::Icons-->
        ...
        <!--end::Head-->
        <!--begin::Summary-->
        <div class="fs-base fw-normal text-gray-700 mb-4">{{ question.content }}</div>
        <!--end::Summary-->
        <!--begin::Foot-->
        <div class="d-flex flex-stack flex-wrap">
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <div class="symbol symbol-35px me-2">
                    <div class="symbol-label bg-light-success fs-3 fw-bold text-success text-uppercase">{{question.user.name.charAt(0)}}</div>
                </div>
                <!--end::Symbol-->
                <!--begin::Name-->
                <div class="d-flex flex-column align-items-start justify-content-center">
                    <span class="text-gray-900 fs-7 fw-bold lh-1 mb-2">{{question.user.name}}</span>
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <a href="../../demo5/dist/apps/devs/question.html#answers"
                    class="btn btn-sm btn-outline btn-outline-dashed btn-outline-default px-4 me-2">0 Cevaplar</a>
                <!--end::Answers-->
                <!--begin::Tags-->
                <a href="../../demo5/dist/apps/devs/tag.html" class="btn btn-sm btn-light px-4 me-2">{{question.tag.name}}</a>
                <!--end::Tags-->
                <!--begin::Upvote-->
...
const data = computed(() => store.state.getQuestions.data)
