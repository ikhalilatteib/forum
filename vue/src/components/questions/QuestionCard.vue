<template>
  <div class="mb-0 ">
    ...
    <div class="d-flex align-items-center mb-4">
      <!--begin::Title-->
      <router-link :to="{name:'ShowQuestion',params:{slug:question.slug}}"
                   class="fs-2 fw-bolder text-gray-900 text-hover-primary me-1">{{ question.title }}
      </router-link>
      <!--end::Title-->
      <!--begin::Icons-->
    ...
    <div class="d-flex flex-stack flex-wrap">
      ...
      <div class="d-flex align-items-center py-1">
        ...
        <!--end::Answers-->
        <!--begin::Tags-->
        <a href="../../demo5/dist/apps/devs/tag.html" class="btn btn-sm btn-light px-4 me-2">
          {{ question.tag_id.name }}
        </a>
        <!--end::Tags-->
        <!--begin::Upvote-->
        <a href="#" class="btn btn-sm btn-flex btn-light px-3 me-2" data-bs-toggle="tooltip"
        ...
        <!--begin::Upvote-->
        <div v-if="token">
          <router-link v-if="user.id===question.user.id" :to="{ name: 'EditQuestion', params: {slug: question.slug} }"
