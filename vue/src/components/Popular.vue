<template>
    ...
    <div class="card bg-light mb-5 mb-lg-10 shadow-none border-0">
        ...
        <div class="card-header align-items-center border-0">
            <!--begin::Title-->
            <h3 class="card-title fw-bolder text-gray-900 fs-3">Popüler Sorular</h3>
            <!--end::Title-->
        </div>
        <!--end::Header-->
        <!--begin::Body-->
        <div class="card-body pt-0">
            <!--begin::Item-->
            <div v-for="(item,index) in data" :key="index" class="d-flex mb-5">
                <!--begin::Arrow-->
                ...
                <a href="../../demo5/dist/apps/devs/question.html"
                    class="text-gray-700 text-hover-primary fs-6 fw-bold">{{item.title}}</a>
                <!--end::Title-->
            </div>
            <!--end::Item-->
        </div>
