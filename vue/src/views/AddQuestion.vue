  ...
  <div class="toolbar d-flex flex-stack flex-wrap mb-5 mb-lg-7" id="kt_toolbar">
    ...
    <div class="page-title d-flex flex-column py-1">
      ...
      <h1 class="d-flex align-items-center my-1">
        <span class="text-dark fw-bolder fs-1">{{ route.params.slug ? model.title : 'Soru Sor' }}</span>
      </h1>
      <!--end::Title-->
      <!--begin::Breadcrumb-->
      <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <li class="breadcrumb-item text-muted">
          <router-link :to="{ name: 'Dashboard' }" class="text-muted text-hover-primary">Ana Sayfa
          </router-link>
        </li>
        <!--end::Item-->
        <!--begin::Item-->
  ...
  <div class="post" id="kt_post">
    ...
    <form id="kt_devs_ask_form" class="form" @submit="addQuestion">
      ...
      <div class="d-flex flex-column mb-8 fv-row">
        ...
        <!--end::Label-->
        <!--begin::Form control-->
        <input type="text" class="form-control" placeholder="Sorunun Başlığı" v-model="model.title"/>
        <!--end::Form control-->
      </div>
      <!--end::Input group-->
      <!--begin::Input group-->
      <div class="d-flex flex-column mb-8">
        ...
        <!--begin::Form control-->
        <div class="fv-row">
                    <textarea class="form-control mb-3" rows="10" v-model="model.content"
      ...
      <div class="d-flex flex-column mb-8">
        ...
        <select class="form-select " data-control="select2" data-placeholder="Select a product"
                v-model="model.tag_id" data-allow-clear="true">
          <option value=""></option>
          <option v-for="(tagDat, index) in tagData" :key="index" :value="tagDat.id" :selected="model.tag_id.name===tagDat.name">
            {{ tagDat.name }}
          </option>
        </select>
        <!--end::Form control-->
